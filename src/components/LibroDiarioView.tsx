...
export const LibroDiarioView: React.FC<LibroDiarioViewProps> = ({ entries, onNewEntry, onGoBack }) => {
  return (
    <div className="flex flex-col h-full animate-in fade-in duration-300">
        ...
        <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200 mb-6 flex gap-4">
            <div className="relative flex-grow">
                ...
                <input
                    ...
                    placeholder="Buscar por glosa, cuenta o folio..."
                />
            </div>
        ...
        {entries.length === 0 ? (
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-16 text-center">
                ...
                <h3 className="text-lg font-medium text-gray-900">Libro Diario Vacío</h3>
                <p className="mt-2 text-sm text-gray-500">No hay asientos contables registrados en el periodo seleccionado.</p>
            </div>
        ) : (
                            ...
                            <div>
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className={`px-2 py-0.5 rounded text-xs font-bold uppercase ${
                                        entry.type === 'ingreso' ? 'bg-emerald-100 text-emerald-700' :
